...
round(mean(mobilome_COG_hits[which(mobilome_COG_hits$Subtype == "Transposon"), "OR"]), 2)
round(sd(mobilome_COG_hits[which(mobilome_COG_hits$Subtype == "Transposon"), "OR"]), 2)
