...
dnds_vs_si_cor <- cor.test(pangenome$mean_percent_singletons_per9, pangenome$dnds, method = "spearman")
ds_vs_si_cor <- cor.test(pangenome$mean_percent_singletons_per9, pangenome$ds, method = "spearman")
...
dnds_vs_sisp_cor <- cor.test(pangenome$si_sp, pangenome$dnds, method = "spearman")
ds_vs_sisp_cor <- cor.test(pangenome$si_sp, pangenome$ds, method = "spearman")
