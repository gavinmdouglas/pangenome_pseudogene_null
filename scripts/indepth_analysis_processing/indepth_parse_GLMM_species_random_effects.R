...
random_effects_ultra.cloud_species <- glmmTMB::ranef(ultra.cloud_model$COG.only_species.interaction_redundant.both.interaction)$cond$species
...
random_effects_other.cloud_species <- glmmTMB::ranef(other.cloud_model$COG.only_species.interaction_redundant.both.interaction)$cond$species
...
random_effects_shell_species <- glmmTMB::ranef(shell_model$COG.only_species.interaction_redundant.both.interaction)$cond$species
