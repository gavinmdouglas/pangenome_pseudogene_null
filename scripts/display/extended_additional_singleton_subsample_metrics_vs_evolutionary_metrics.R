...
ggsave(filename = '/home/gdouglas/scripts/pangenome_pseudogene_null/display_items/extended_figure_additional_subsample_singletons_vs_evolution_metrics.pdf',
       plot = combined,
       device = 'pdf',
       dpi = 400,
       width = 10,
